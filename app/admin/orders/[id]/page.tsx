              ...
              <div className="mt-5 space-y-3">
                ...
                {order.paymentStatus !== "PAID" && (
                  <form action={markAsPaid}>
                    <button className="w-full rounded-full bg-zinc-950 px-5 py-3 text-sm font-bold text-white hover:bg-zinc-800">
                ...
                {order.paymentStatus === "PAID" && order.status === "PENDING" && (
                  <form action={markAsProcessing}>
                    <button className="w-full rounded-full bg-blue-600 px-5 py-3 text-sm font-bold text-white hover:bg-blue-700">
                      📦 Mulai packing
                    </button>
                  </form>
                )}
                ...
                {order.status === "SHIPPED" && (
                  <form action={markAsDelivered}>
                    <button className="w-full rounded-full bg-emerald-600 px-5 py-3 text-sm font-bold text-white hover:bg-emerald-700">
                      ✅ Tandai selesai
                    </button>
                  </form>
                )}
                ...
                <form action={markAsCancelled}>
                  <button className="w-full rounded-full border border-red-200 px-5 py-3 text-sm font-bold text-red-600 hover:bg-red-50">
                    Batalkan order
                  </button>
                </form>
              </div>
