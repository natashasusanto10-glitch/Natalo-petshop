...
export default async function AdminCustomersPage({
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-6 lg:py-10">
      <div>
        <h1 className="text-2xl font-black tracking-tight text-zinc-950 lg:text-3xl">Customer</h1>
        <p className="mt-1 text-sm text-zinc-500">{total} customer terdaftar.</p>
      </div>
      ...
      <div className="mt-6 overflow-hidden rounded-3xl border border-zinc-200 bg-white">
        {customers.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <p className="mt-3 font-semibold text-zinc-700">Belum ada customer</p>
          </div>
        ) : (
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-zinc-100 bg-zinc-50">
                  <th className="px-5 py-4 text-left font-semibold text-zinc-600">Nama</th>
                  <th className="px-5 py-4 text-left font-semibold text-zinc-600 hidden sm:table-cell">Email / HP</th>
                  <th className="px-5 py-4 text-left font-semibold text-zinc-600">Order</th>
                  <th className="px-5 py-4 text-left font-semibold text-zinc-600 hidden md:table-cell">Bergabung</th>
                </tr>
              </thead>
              <tbody>
