...
export default function KebijakanPengembalianPage() {
  return (
    <LegalPage title="Kebijakan Pengembalian & Refund" updated="Januari 2026">
      ...
      <Section title="Syarat Pengembalian Produk">
        ...
        kondisi asli, kemasan lengkap, belum digunakan, dan belum dibuka kecuali
        kerusakan baru terlihat saat produk diterima.
      </Section>
      ...
      <Section title="Prosedur Pengembalian">
        Hubungi kami melalui WhatsApp maksimal 1x24 jam setelah produk diterima.
        Tim kami akan memeriksa bukti komplain dan memberi keputusan/instruksi
        lanjutan. Jika komplain disetujui, proses pengembalian atau penggantian
        diselesaikan maksimal 2x24 jam setelah persetujuan, tidak termasuk waktu
        pengiriman dari pihak kurir.
      </Section>

      <Section title="Proses Refund">
        Refund diproses setelah komplain disetujui dan, bila diperlukan, produk
        telah dikembalikan serta diperiksa kondisinya. Pencairan dana mengikuti
        metode pembayaran: transfer bank 1-3 hari kerja dan e-wallet 1 hari
        kerja. Biaya pengiriman awal tidak direfund, kecuali kesalahan ada di
        pihak kami.
      </Section>
      ...
      <Section title="Produk Rusak saat Pengiriman">
        ...
        Jika klaim disetujui, kami akan membantu penggantian produk atau refund
