  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-4xl px-4 pb-24 pt-4 md:py-10">
        ...
        {showCreatedSuccess && (
          <section className="mt-5 rounded-[2rem] border border-blue-100 bg-white p-5 text-center shadow-[0_18px_50px_rgba(21,101,216,0.10)] md:p-7">
        ...
        <div
          id="detail-pesanan"
          className="mt-5 scroll-mt-28 grid gap-5 lg:grid-cols-[1.15fr_0.85fr]"
        >
