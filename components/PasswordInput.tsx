  ...
  return (
    <div className="relative mt-1">
      ...
      <button
        ...
        onClick={toggle}
        className="absolute right-1 top-1/2 z-10 flex h-11 w-11 -translate-y-1/2 cursor-pointer items-center justify-center text-[#999] transition hover:text-[#468284] active:text-[#468284]"
        style={{
