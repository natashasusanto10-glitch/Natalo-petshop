      ...
      <div className="sticky top-[76px] z-30 bg-[#FAFAFA]/95 px-4 py-3 backdrop-blur-md md:hidden">
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex flex-1 items-center gap-2 rounded-full border border-[#f0f0f0] bg-white px-4 py-2.5 text-left shadow-sm transition hover:border-blue-200"
          >
            <svg
              viewBox="0 0 24 24"
              fill="none"
            ...
            <span
              aria-hidden
              className="flex h-6 w-6 items-center justify-center rounded-full text-blue-500"
            >
              <svg
                viewBox="0 0 24 24"
                fill="none"
          ...
          <a
            ...
            className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-blue-500 text-white shadow-sm active:opacity-90"
          >
