...
/// Reports a newly copied video-output buffer, not proof of GPU presentation.
typedef void (^FVPFrameOutputCallback)(int64_t frameCount, int64_t mediaTimeUs,
...
/// Called after a genuinely new, non-null pixel buffer is copied from the video output.
@property(nonatomic, copy, nullable) FVPFrameOutputCallback frameOutputCallback;
