...
public abstract class VideoPlayer implements VideoPlayerInstanceApi {
  ...
  @Nullable private FrameOutputEventChannel.PlayerListener frameOutputListener;
  ...
  public void setFrameOutputListener(@NonNull FrameOutputEventChannel.PlayerListener listener) {
  ...
  @Override
  public void play() {
    if (frameOutputListener != null) {
      frameOutputListener.setActive(true);
    }
    exoPlayer.play();
  }
  ...
  public void pause() {
    if (frameOutputListener != null) {
      frameOutputListener.setActive(false);
    }
    exoPlayer.pause();
  }
  ...
  public void dispose() {
    if (frameOutputListener != null) {
      frameOutputListener.dispose();
      frameOutputListener = null;
