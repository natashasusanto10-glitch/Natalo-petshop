...
public class VideoPlayerPlugin implements FlutterPlugin, AndroidVideoPlayerApi {
  ...
  @Nullable private FrameOutputEventChannel frameOutputEventChannel;
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding binding) {
    ...
    frameOutputEventChannel = new FrameOutputEventChannel(binding.getBinaryMessenger());
  ...
  public void onDetachedFromEngine(@NonNull FlutterPluginBinding binding) {
    ...
    onDestroy();
    frameOutputEventChannel.detach();
    frameOutputEventChannel = null;
  ...
  public long createForPlatformView(@NonNull CreationOptions options) {
    ...
    registerPlayerInstance(videoPlayer, id, null);
    return id;
  }
  ...
  public @NonNull TexturePlayerIds createForTextureView(@NonNull CreationOptions options) {
    ...
    registerPlayerInstance(videoPlayer, id, handle.id());
  ...
  private void registerPlayerInstance(VideoPlayer player, long id, @Nullable Long textureId) {
    ...
    if (frameOutputEventChannel == null) {
      throw new IllegalStateException("Frame-output channel is unavailable.");
    }
    player.setFrameOutputListener(frameOutputEventChannel.createPlayerListener(id, textureId));
