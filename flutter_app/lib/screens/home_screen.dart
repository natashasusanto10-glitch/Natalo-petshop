                  ...
                  SliverPadding(
                    ...
                    sliver: SliverGrid(
                      gridDelegate:
                        ...
                        mainAxisSpacing: 12,
                        crossAxisSpacing: 12,
                        // 0.62 → 0.58 — fix ProductCard overflow di explore.
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          // Pakai TextField disabled supaya inherit InputDecorationTheme
          // dari NataloTheme (radius 16, fill white, border light gray).
          GestureDetector(
            onTap: onOpenSearch,
            child: AbsorbPointer(
              child: SizedBox(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: 'Cari makanan, vitamin, pasir...',
                    ...
                    // Override disabled border supaya tetap visible bagus
                    // (default disabled jadi terlalu pucat).
        ...
        children: [
          ...
          GridView.builder(
            ...
            gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
              ...
              mainAxisSpacing: 12,
              crossAxisSpacing: 12,
              // 0.62 → 0.58 — fix ProductCard overflow.
              childAspectRatio: 0.58,
            ),
            itemBuilder: (context, index) {
              final product = products[index];
