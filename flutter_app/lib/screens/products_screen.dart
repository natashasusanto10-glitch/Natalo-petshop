...
const _stockGreen = Color(0xFF16A34A);
...
// _CatalogFilterChipsRow + _FilterChip removed — replaced by
// _GlassyFilterBar + _FilterPill (pinned sticky version) di atas.
              ...
              children: [
                Expanded(
                  child: Text(
                    ...
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(
                      color: outOfStock ? _dangerRed : _stockGreen,
                      fontSize: 12.5,
                      fontWeight: FontWeight.w800,
                    ),
                  ),
                ),
                _CatalogAddToCartButton(
                  product: product,
                  disabled: outOfStock,
                  onNeedsVariant: onTap,
                ),
              ],
            ),
          ],
...
class _ProductRatingSoldMeta extends StatelessWidget {
  final double rating;
  final int soldCount;

  const _ProductRatingSoldMeta({
...
class _CatalogAddToCartButton extends StatelessWidget {
  final Product product;
  final bool disabled;
  final VoidCallback onNeedsVariant;

  const _CatalogAddToCartButton({
    required this.product,
    required this.disabled,
    required this.onNeedsVariant,
  });
  ...
  Widget build(BuildContext context) {
    return Material(
      color: disabled ? const Color(0xFFE2E8F0) : _brandBlue,
      borderRadius: BorderRadius.circular(15),
      elevation: disabled ? 0 : 4,
      shadowColor: _brandBlue.withValues(alpha: 0.24),
      child: InkWell(
        onTap: disabled ? null : () => _add(context),
        borderRadius: BorderRadius.circular(15),
        child: SizedBox(
          width: 42,
          height: 42,
