...
export function serializeOrderDetail(order: OrderDetailRecord) {
  ...
  return {
    ...
    paymentProofVersion: order.paymentProofVersion,
    paymentProofUploadedAt: order.paymentProofUploadedAt?.toISOString() ?? null,
    paymentProofReviewedAt: order.paymentProofReviewedAt?.toISOString() ?? null,
    paymentProofRejectReason: order.paymentProofRejectReason,
